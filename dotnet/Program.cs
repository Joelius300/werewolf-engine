...
class WerewolfNightAction : BaseAction<WerewolfInputRequest, WerewolfInputSubmission>
{
...
interface IPendingAction<out TInputRequest, in TInputSubmission> : IAction
...
interface IReadyAction : IAction
{
    Game Transform(Game game);
}

abstract class BaseAction<TInputRequest, TInputSubmission> : IPendingAction<TInputRequest, TInputSubmission>,
    IReadyAction
    where TInputRequest : IInputRequest
    where TInputSubmission : IInputSubmission
{
